    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvContacts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                TextView contactName = MyDialog.findViewById(R.id.btnPopupName);
                contactName.setText(conName);
                TextView contactNumber = MyDialog.findViewById(R.id.btnPopupNumber);
                contactNumber.setText(conPhone);
                TextView contactEmail = MyDialog.findViewById(R.id.btnPopupAddress);
                contactEmail.setText(conEmail);
